...
Given the data from The Word Bank do animated line plots (gif file) for all years for
...
def save_gif():
    """save_gif
     ...
     Returns:
         ...
         """
    ff = ffmpy.FFmpeg(
        inputs={"../images/fig7.mp4": None},
        outputs={"../images/fig7.gif": None})
    ff.run()
